...
/**
 * @typedef {'select' | 'rectangle' | 'ellipse' | 'rhombus' | 'arrow' | 'draw' | 'text' | 'image' | 'eraser'} ToolType
 */

/**
 * @typedef {Object} Element
 * @property {string} id - Unique identifier
 * @property {'rectangle' | 'ellipse' | 'rhombus' | 'arrow' | 'draw' | 'text' | 'image'} type - Element type
 ...
 * @property {string} [src] - For image elements
 */
